...
export default function Form() {
	return (
		<div className='w-screen flex justify-center z-10'>
			<div className='py-8 w-fit px-12 md:px-28 bg-[#30284A] backdrop-blur-3xl  bg-[#30284A]/50 min-w-5/6 flex flex-col justify-center rounded-lg shadow-2xl shadow-slate-950 gap-5'>
